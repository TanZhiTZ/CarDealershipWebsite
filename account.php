...
if (isset($_POST['update'])) {
  ...
  if (password_verify($old_password, $row['password'])) {
    ...
    if (!preg_match('/^(?=.*[a-zA-Z])(?=.*[\W_]).{6,}$/', $password)) {
      echo "<script>alert('Password must be at least 6 characters long and contain at least one letter and one special character.');</script>";
